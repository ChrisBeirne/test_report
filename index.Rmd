...
```{r, echo=F, warning=F, message=F}
 ...
 tmp <- tmp[,c("local.identifier","clus_age_hrs","date","time.range" ,"rest.mean.long", "rest.mean.lat", "rest.nposi", "rest.duration", "code")]
 colnames(tmp) <- c("name","cluster_age", "date","timeRange", "long", "lat", "npos", "duration", "code")
