...
# Movebank data update
*Last updated: `r as.POSIXct(format(Sys.time()),tz="America/Costa_Rica")`*
...
tmp <- last_sum[, c("animalName","country", "diff_time")]
colnames(tmp)[colnames(tmp)=="diff_time"] <- "time_since_checkin"
tmp <- tmp[order(tmp$country, tmp$time_since_checkin),]
```
