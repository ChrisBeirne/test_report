...
We currently have `r length(unique(tmp_pe$name))` devices actively transmitting data in Peru:
...
```{r}
tmp_shp <- dat_shp[dat_shp$taxon_canonical_name %in% c("Panthera onca", "Puma concolor", "Leopardus pardus"),]
